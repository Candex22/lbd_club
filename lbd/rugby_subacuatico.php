...
<head>
    ...
    <title>Equipo de rugby subacuatico</title>
...
<body class="body">
    <header>
        ...
        <h1>Equipo de rugby subacuatico</h1>
    ...
    <?php
      ...
      $sql = "SELECT * FROM rugby WHERE entrenador = 1";
    ...
    ?>
        ...
        <?php
          ...
          $sql = "SELECT * FROM rugby WHERE entrenador IS NULL ORDER BY posicion";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
